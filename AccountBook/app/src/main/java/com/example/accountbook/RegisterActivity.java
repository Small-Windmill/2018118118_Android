...
public class RegisterActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private EditText mEtRgisteractivityPhonecodes;
    ...
    private void init() {
        mBtRegisteractivityRegister = findViewById(R.id.bt_registeractivyty_register);
        mIvRegisteractivityBack = findViewById(R.id.iv_registeractivity_back);
        mEtRegisteractivityUsername = findViewById(R.id.et_registeractivity_username);
        mEtRegisteractivityPassword1 = findViewById(R.id.et_registeractivity_password1);
        mEtRegisteractivityPassword2 = findViewById(R.id.et_registeractivity_password2);
        mEtRgisteractivityPhonecodes = findViewById(R.id.et_registeractivyty_phoneCodes);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.iv_registeractivity_showCode:
                ...
                realCode = Code.getInstance().getCode().toLowerCase();
                break;
            case R.id.bt_registeractivyty_register:
                ...
                String phoneCode = mEtRgisteractivityPhonecodes.getText().toString().toLowerCase();
