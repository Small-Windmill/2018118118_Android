...
public class Sum_Fragment extends Fragment {
    ...
    TextView tv_shou;
    TextView tv_zhi;
    TextView tv_salary,tv_bonus,tv_jianzhi;
    TextView tv_food,tv_clothes,tv_life,tv_others;
    TextView tv_sum;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        tv_bonus=(TextView)view.findViewById(R.id.tv_bonus);
        ...
        NumAnim.startAnim(tv_salary, gongzi, 1000);     //设置滚动动画持续1秒
        NumAnim.startAnim(tv_bonus, jiangjin, 1000);     //设置滚动动画持续1秒
        ...
        NumAnim.startAnim(tv_others, qita, 1000);     //设置滚动动画持续1秒
